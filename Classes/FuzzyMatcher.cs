...
internal readonly struct FuzzyMatcher {
    ...
    private readonly char[] needleSpan;
    ...
    public FuzzyMatcher(string term, MatchMode matchMode) {
        needleString = term;
        needleSpan = needleString.AsSpan().ToArray();
    ...
    private (int StartPos, int Gaps, int Consecutive, int BorderMatches, int HaystackIndex) FindForward(ReadOnlySpan<char> haystack, int needleStart, int needleEnd) {
    ...
    private (int StartPos, int Gaps, int Consecutive, int BorderMatches) FindReverse(ReadOnlySpan<char> haystack, int haystackLastMatchIndex, int needleStart, int needleEnd) {
